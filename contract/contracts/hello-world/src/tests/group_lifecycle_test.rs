...
fn test_full_group_lifecycle() {
    ...
    members.push_back(GroupMember { address: member1.clone(), percentage: 50 });
    members.push_back(GroupMember { address: member2.clone(), percentage: 30 });
    members.push_back(GroupMember { address: member3.clone(), percentage: 20 });
    ...
    new_members.push_back(GroupMember { address: member1.clone(), percentage: 40 });
    new_members.push_back(GroupMember { address: member2.clone(), percentage: 30 });
    new_members.push_back(GroupMember { address: member3.clone(), percentage: 20 });
    new_members.push_back(GroupMember { address: member4.clone(), percentage: 10 });
